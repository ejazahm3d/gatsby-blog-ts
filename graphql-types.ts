...
export type ContentfulBlogPostFieldsEnum = 
  ...
  | 'featuredImage___resolutions___base64'
  | 'featuredImage___resolutions___tracedSVG'
  | 'featuredImage___resolutions___aspectRatio'
  | 'featuredImage___resolutions___width'
  | 'featuredImage___resolutions___height'
  | 'featuredImage___resolutions___src'
  | 'featuredImage___resolutions___srcSet'
  | 'featuredImage___resolutions___srcWebp'
  | 'featuredImage___resolutions___srcSetWebp'
  ...
  | 'featuredImage___sizes___base64'
  | 'featuredImage___sizes___tracedSVG'
  | 'featuredImage___sizes___aspectRatio'
  | 'featuredImage___sizes___src'
  | 'featuredImage___sizes___srcSet'
  | 'featuredImage___sizes___srcWebp'
  | 'featuredImage___sizes___srcSetWebp'
  | 'featuredImage___sizes___sizes'
...
export type AllBlogsQuery = { allContentfulBlogPost: { edges: Array<{ node: (
        Pick<ContentfulBlogPost, 'title' | 'id' | 'slug' | 'publishedDate'>
        & { featuredImage?: Maybe<{ fluid?: Maybe<GatsbyContentfulFluidFragment> }>, excerpt?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'excerpt'>> }> }
      ) }> } };
